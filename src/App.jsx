...
const BREAKFAST_RECIPES = [
  { id: "breakfast-scrambled-eggs", title: "Classic Scrambled Eggs on Toast", category: "Breakfast", time: "10 min", baseServings: 2,
    ingredients: [ing(4, "", "large eggs"), ing(40, "g", "butter"), ing(60, "ml", "milk or cream"), ing(4, "", "slices thick sourdough"), ing(null, "", "salt, pepper and chives, to serve")],
    steps: ["Whisk the eggs with the milk and a little salt and pepper.", "Melt half the butter in a nonstick pan over low heat. Add the eggs and stir gently and constantly with a spatula until softly set — don't rush it.", "Toast the sourdough and butter it while hot.", "Pile the eggs onto the toast and scatter with chives."],
    notes: "Low heat and constant stirring is the whole trick — rushing scrambled eggs is the only way to ruin them." },
  { id: "breakfast-avocado-smash", title: "Avocado Smash on Sourdough", category: "Breakfast", time: "10 min", baseServings: 2,
    ingredients: [ing(2, "", "ripe avocados"), ing(1, "", "lemon, juiced"), ing(0.5, "tsp", "chilli flakes"), ing(4, "", "slices sourdough"), ing(1, "tbsp", "olive oil"), ing(50, "g", "feta, crumbled, optional"), ing(100, "g", "cherry tomatoes, halved, optional")],
    steps: ["Mash the avocado roughly with the lemon juice, chilli flakes and a pinch of salt.", "Toast the sourdough and drizzle with olive oil.", "Top with the smashed avocado, feta and tomatoes if using."],
    notes: "" },
  { id: "breakfast-bircher-muesli", title: "Bircher Muesli (Overnight Oats)", category: "Breakfast", time: "10 min + overnight", baseServings: 4,
    ingredients: [ing(200, "g", "rolled oats"), ing(500, "ml", "apple juice"), ing(200, "g", "apple, grated"), ing(200, "g", "natural yoghurt"), ing(50, "g", "sultanas"), ing(50, "g", "almonds, chopped"), ing(1, "tsp", "ground cinnamon")],
    steps: ["Combine the oats, apple juice, yoghurt and cinnamon in a large bowl.", "Stir through the grated apple and sultanas.", "Cover and refrigerate overnight.", "Stir through the almonds just before serving, topped with extra fruit if you like."],
    notes: "Keeps well for 3–4 days in the fridge — a good one to batch on a Sunday." },
  { id: "breakfast-fluffy-pancakes", title: "Fluffy Pancakes with Maple Syrup", category: "Breakfast", time: "20 min", baseServings: 4,
    ingredients: [ing(300, "g", "self-raising flour"), ing(2, "tbsp", "caster sugar"), ing(null, "", "pinch of salt"), ing(2, "", "large eggs"), ing(350, "ml", "milk"), ing(50, "g", "unsalted butter, melted, plus extra for cooking"), ing(null, "", "maple syrup, to serve")],
    steps: ["Sift the flour, sugar and salt into a bowl.", "Whisk the eggs, milk and melted butter together, then pour into the dry ingredients and mix until just combined — a few small lumps are fine.", "Heat a nonstick pan over medium heat with a little butter. Ladle in the batter and cook until bubbles form on the surface, then flip and cook the other side until golden.", "Stack and serve with maple syrup."],
    notes: "" },
  { id: "breakfast-shakshuka", title: "Shakshuka (Baked Eggs in Tomato Sauce)", category: "Breakfast", time: "30 min", baseServings: 4,
    ingredients: [ing(2, "tbsp", "olive oil"), ing(1, "", "brown onion, diced"), ing(1, "", "red capsicum, diced"), ing(2, "", "garlic cloves, crushed"), ing(1, "tsp", "ground cumin"), ing(1, "tsp", "smoked paprika"), ing(0.5, "tsp", "chilli flakes"), ing(700, "g", "tomato passata"), ing(6, "", "large eggs"), ing(80, "g", "feta, crumbled"), ing(null, "", "parsley and crusty bread, to serve")],
    steps: ["Heat the oil in a large deep pan and cook the onion and capsicum until soft, about 8 minutes.", "Add the garlic and spices and cook for 1 minute until fragrant.", "Pour in the passata and simmer, uncovered, for 10 minutes until slightly thickened.", "Make six wells in the sauce and crack in the eggs. Cover and cook until the whites are set but the yolks are still runny, 6–8 minutes.", "Scatter with feta and parsley and serve straight from the pan with crusty bread."],
    notes: "" },
  { id: "breakfast-burritos", title: "Breakfast Burritos", category: "Breakfast", time: "20 min", baseServings: 4,
    ingredients: [ing(8, "", "large eggs"), ing(60, "ml", "milk"), ing(200, "g", "bacon, chopped"), ing(1, "", "avocado, sliced"), ing(100, "g", "grated tasty cheese"), ing(4, "", "large tortillas"), ing(null, "", "salsa and hot sauce, to serve")],
    steps: ["Cook the bacon in a large pan until crisp, then set aside.", "Whisk the eggs with the milk and scramble gently in the same pan.", "Warm the tortillas.", "Fill each with scrambled egg, bacon, cheese and avocado, roll up and serve with salsa."],
    notes: "" },
  { id: "breakfast-smoothie-bowl", title: "Banana Smoothie Bowl", category: "Breakfast", time: "10 min", baseServings: 2,
    ingredients: [ing(3, "", "frozen bananas"), ing(250, "ml", "milk (or milk alternative)"), ing(2, "tbsp", "peanut butter"), ing(1, "tbsp", "honey"), ing(null, "", "granola, fresh berries and coconut flakes, to top")],
    steps: ["Blend the frozen banana, milk, peanut butter and honey until thick and smooth — stop and scrape down the sides if it needs a hand.", "Pour into bowls and top with granola, berries and coconut flakes."],
    notes: "" },
  { id: "breakfast-toasted-muesli", title: "Toasted Muesli", category: "Breakfast", time: "30 min", scaling: "batch", yield: "Makes about 1 kg", baseServings: 1,
    ingredients: [ing(400, "g", "rolled oats"), ing(100, "g", "slivered almonds"), ing(100, "g", "pepitas"), ing(50, "g", "sunflower seeds"), ing(80, "g", "desiccated coconut"), ing(100, "g", "honey or maple syrup"), ing(80, "ml", "vegetable oil"), ing(1, "tsp", "vanilla extract"), ing(1, "tsp", "ground cinnamon"), ing(100, "g", "dried cranberries or sultanas")],
    steps: ["Preheat oven to 150°C fan-forced and line two baking trays.", "Combine the oats, almonds, pepitas, sunflower seeds and coconut in a large bowl.", "Warm the honey, oil, vanilla and cinnamon together, then pour over the dry mix and stir until well coated.", "Spread over the trays and bake 25–30 minutes, stirring halfway, until golden.", "Cool completely on the trays, then stir through the dried fruit. Store airtight for up to a month."],
    notes: "" },
  { id: "breakfast-french-toast", title: "French Toast", category: "Breakfast", time: "20 min", baseServings: 4,
    ingredients: [ing(4, "", "large eggs"), ing(150, "ml", "milk"), ing(1, "tsp", "vanilla extract"), ing(0.5, "tsp", "ground cinnamon"), ing(8, "", "slices thick white bread or brioche"), ing(30, "g", "butter, for frying"), ing(null, "", "maple syrup and berries, to serve")],
    steps: ["Whisk the eggs, milk, vanilla and cinnamon together in a wide, shallow bowl.", "Dip each slice of bread in the mixture, coating both sides.", "Fry in butter over medium heat until golden on both sides.", "Serve stacked with maple syrup and berries."],
    notes: "" },
  { id: "breakfast-omelette", title: "Vegetable & Cheese Omelette", category: "Breakfast", time: "10 min", baseServings: 2,
    ingredients: [ing(4, "", "large eggs"), ing(2, "tbsp", "milk"), ing(30, "g", "butter"), ing(50, "g", "grated cheese"), ing(60, "g", "capsicum, diced"), ing(2, "", "spring onions, sliced")],
    steps: ["Whisk the eggs with the milk and season well.", "Melt the butter in a small nonstick pan over medium heat and pour in the eggs.", "Scatter the capsicum, spring onion and cheese over one half as the eggs begin to set.", "Once almost set, fold in half and slide onto a plate."],
    notes: "" },
  { id: "breakfast-bacon-egg-rolls", title: "Bacon & Egg Rolls", category: "Breakfast", time: "15 min", baseServings: 4,
    ingredients: [ing(8, "", "bacon rashers"), ing(4, "", "large eggs"), ing(4, "", "bread rolls"), ing(20, "g", "butter"), ing(null, "", "BBQ or tomato sauce, to serve")],
    steps: ["Grill or pan-fry the bacon until crisp.", "Fry the eggs in the same pan to your liking.", "Butter the rolls, stack with bacon and egg, and finish with sauce."],
    notes: "" },
  { id: "breakfast-chia-pudding", title: "Chia Seed Pudding", category: "Breakfast", time: "10 min + 4 hrs chilling", baseServings: 4,
    ingredients: [ing(90, "g", "chia seeds"), ing(500, "ml", "milk (dairy or plant-based)"), ing(2, "tbsp", "maple syrup"), ing(1, "tsp", "vanilla extract"), ing(null, "", "fresh fruit, to top")],
    steps: ["Whisk the chia seeds, milk, maple syrup and vanilla together in a bowl or jar.", "Let sit 5 minutes, then whisk again to break up any clumps.", "Cover and refrigerate for at least 4 hours, or overnight.", "Stir before serving and top with fresh fruit."],
    notes: "" },
  { id: "breakfast-eggs-benedict", title: "Eggs Benedict with Hollandaise", category: "Breakfast", time: "25 min", baseServings: 4,
    ingredients: [ing(4, "", "English muffins, split"), ing(8, "", "slices leg ham"), ing(8, "", "large eggs, for poaching"), ing(1, "tbsp", "white vinegar"), ing(3, "", "egg yolks, for the hollandaise"), ing(200, "g", "unsalted butter, melted"), ing(1, "tbsp", "lemon juice"), ing(null, "", "chives, to garnish")],
    steps: ["Toast the muffins and warm the ham.", "Poach the eggs in barely simmering water with the vinegar, about 3 minutes each.", "For the hollandaise, whisk the egg yolks and lemon juice in a heatproof bowl over a saucepan of simmering water until pale and thickened, then slowly drizzle in the melted butter, whisking constantly, until thick and glossy.", "Stack muffin, ham and a poached egg, spoon over the hollandaise and scatter with chives."],
    notes: "" },
  { id: "breakfast-huevos-rancheros", title: "Huevos Rancheros", category: "Breakfast", time: "30 min", baseServings: 4,
    ingredients: [ing(2, "tbsp", "olive oil"), ing(1, "", "brown onion, diced"), ing(2, "", "garlic cloves, crushed"), ing(1, "tsp", "ground cumin"), ing(800, "g", "tinned crushed tomatoes (two tins)"), ing(400, "g", "tinned black beans, drained"), ing(4, "", "corn tortillas"), ing(4, "", "large eggs"), ing(100, "g", "feta, crumbled"), ing(1, "", "avocado, sliced"), ing(null, "", "coriander, to serve")],
    steps: ["Cook the onion in the oil until soft, then add the garlic and cumin and cook 1 minute.", "Add the tomatoes and beans and simmer 15 minutes until thickened.", "Make four wells in the sauce, crack in the eggs, cover and cook until the whites are set.", "Warm the tortillas and serve the sauce and egg over them, topped with feta, avocado and coriander."],
    notes: "" },
  { id: "breakfast-quesadillas", title: "Breakfast Quesadillas", category: "Breakfast", time: "20 min", baseServings: 4,
    ingredients: [ing(8, "", "large eggs"), ing(60, "ml", "milk"), ing(8, "", "flour tortillas"), ing(200, "g", "grated tasty cheese"), ing(150, "g", "bacon or ham, chopped"), ing(2, "", "spring onions, sliced"), ing(20, "g", "butter, for the pan"), ing(null, "", "salsa and sour cream, to serve")],
    steps: ["Whisk the eggs and milk and scramble softly with the bacon or ham.", "Lay out the tortillas, scatter cheese, the egg mixture and spring onion over half of each, then fold over.", "Cook in a buttered pan until golden and the cheese melts, flipping once.", "Cut into wedges and serve with salsa and sour cream."],
    notes: "" },
  { id: "breakfast-sweetcorn-fritters", title: "Sweetcorn Fritters with Bacon and Avocado", category: "Breakfast", time: "25 min", baseServings: 4,
    ingredients: [ing(400, "g", "tinned corn kernels, drained"), ing(150, "g", "plain flour"), ing(2, "tsp", "baking powder"), ing(2, "", "large eggs"), ing(80, "ml", "milk"), ing(2, "", "spring onions, sliced"), ing(2, "tbsp", "oil, for frying"), ing(8, "", "bacon rashers"), ing(2, "", "avocados, sliced"), ing(null, "", "lime wedges, to serve")],
    steps: ["Whisk the flour, baking powder, eggs and milk into a smooth batter, then stir through the corn and spring onion.", "Fry the bacon until crisp and set aside.", "Fry spoonfuls of the batter in a lightly oiled pan, 2–3 minutes each side until golden.", "Serve the fritters topped with bacon and avocado, with lime on the side."],
    notes: "" },
  { id: "breakfast-baked-beans", title: "Homemade Baked Beans on Toast", category: "Breakfast", time: "30 min", baseServings: 4,
    ingredients: [ing(2, "tbsp", "olive oil"), ing(1, "", "brown onion, diced"), ing(2, "", "garlic cloves, crushed"), ing(800, "g", "tinned crushed tomatoes (two tins)"), ing(800, "g", "tinned cannellini beans, drained (two tins)"), ing(2, "tbsp", "brown sugar"), ing(1, "tbsp", "Worcestershire sauce"), ing(1, "tsp", "smoked paprika"), ing(8, "", "slices sourdough, toasted")],
    steps: ["Cook the onion in the oil until soft, then add the garlic and cook 1 minute.", "Add the tomatoes, beans, sugar, Worcestershire and paprika.", "Simmer 20 minutes, stirring occasionally, until thick and glossy.", "Season and serve over hot buttered toast."],
    notes: "" },
  { id: "breakfast-croque-madame", title: "Croque Madame", category: "Breakfast", time: "30 min", baseServings: 4,
    ingredients: [ing(8, "", "slices white bread"), ing(60, "g", "butter"), ing(60, "g", "plain flour"), ing(500, "ml", "milk"), ing(100, "g", "grated gruyère"), ing(1, "tsp", "Dijon mustard"), ing(8, "", "slices leg ham"), ing(4, "", "large eggs")],
    steps: ["Melt the butter in a saucepan, whisk in the flour and cook 1 minute.", "Gradually whisk in the milk and simmer until thickened, then stir in half the cheese and the mustard.", "Assemble sandwiches with ham between the bread, spread the sauce on top and scatter with the remaining cheese.", "Grill until golden and bubbling.", "Fry the eggs and top each sandwich with one."],
    notes: "" },
  { id: "breakfast-hash", title: "Breakfast Hash (Potato, Bacon & Egg)", category: "Breakfast", time: "30 min", baseServings: 4,
    ingredients: [ing(800, "g", "potatoes, diced"), ing(2, "tbsp", "olive oil"), ing(200, "g", "bacon, chopped"), ing(1, "", "brown onion, diced"), ing(1, "", "red capsicum, diced"), ing(4, "", "large eggs"), ing(null, "", "chives, to serve")],
    steps: ["Parboil the potatoes 8 minutes, then drain well.", "Heat the oil in a large pan and fry the potatoes until golden and crisp.", "Add the bacon, onion and capsicum, and cook until the bacon is crisp and vegetables softened.", "Make four wells, crack in the eggs, cover and cook until set to your liking.", "Scatter with chives."],
    notes: "" },
  { id: "breakfast-poached-eggs-spinach", title: "Poached Eggs with Spinach and Mushrooms", category: "Breakfast", time: "20 min", baseServings: 4,
    ingredients: [ing(2, "tbsp", "olive oil"), ing(300, "g", "mushrooms, sliced"), ing(2, "", "garlic cloves, crushed"), ing(150, "g", "baby spinach"), ing(8, "", "large eggs"), ing(1, "tbsp", "white vinegar"), ing(4, "", "slices sourdough, toasted"), ing(null, "", "shaved parmesan, to serve")],
    steps: ["Heat the oil and cook the mushrooms until golden, then add the garlic and cook 1 minute.", "Add the spinach and wilt.", "Poach the eggs in barely simmering water with the vinegar, about 3 minutes.", "Pile the mushroom and spinach onto the toast, top with poached eggs and parmesan."],
    notes: "" },
  { id: "breakfast-ricotta-hotcakes", title: "Ricotta Hotcakes with Honeycomb Butter", category: "Breakfast", time: "25 min", baseServings: 4,
    ingredients: [ing(250, "g", "fresh ricotta"), ing(3, "", "large eggs, separated"), ing(150, "g", "self-raising flour"), ing(200, "ml", "milk"), ing(1, "tbsp", "caster sugar"), ing(80, "g", "unsalted butter, softened"), ing(2, "tbsp", "honey"), ing(20, "g", "butter, for cooking")],
    steps: ["Whisk the ricotta, egg yolks, flour, milk and sugar to a smooth batter.", "Whisk the egg whites to soft peaks and fold through the batter.", "For the honeycomb butter, beat the softened butter with the honey until fluffy.", "Cook the batter in a buttered pan over medium heat, 2–3 minutes each side until golden.", "Serve stacked with the honeycomb butter."],
    notes: "" },
  { id: "breakfast-bacon-egg-cheese-muffins", title: "Bacon, Egg and Cheese Breakfast Muffins", category: "Breakfast", time: "15 min", baseServings: 4,
    ingredients: [ing(4, "", "English muffins, split"), ing(8, "", "bacon rashers"), ing(4, "", "large eggs"), ing(4, "", "slices tasty cheese"), ing(20, "g", "butter")],
    steps: ["Grill or fry the bacon until crisp.", "Fry the eggs to your liking.", "Toast and butter the muffins.", "Stack the bacon, egg and cheese between the muffin halves."],
    notes: "" },
  { id: "breakfast-porridge", title: "Classic Porridge with Brown Sugar and Banana", category: "Breakfast", time: "10 min", baseServings: 4,
    ingredients: [ing(200, "g", "rolled oats"), ing(600, "ml", "milk"), ing(200, "ml", "water"), ing(null, "", "pinch of salt"), ing(60, "g", "brown sugar"), ing(2, "", "bananas, sliced"), ing(null, "", "extra milk or cream, to serve")],
    steps: ["Combine the oats, milk, water and salt in a saucepan.", "Bring to a simmer, stirring, and cook 5 minutes until thick and creamy.", "Spoon into bowls and top with brown sugar, banana and a splash of extra milk."],
    notes: "" },
  { id: "breakfast-belgian-waffles", title: "Belgian Waffles", category: "Breakfast", time: "25 min", baseServings: 4,
    ingredients: [ing(250, "g", "plain flour"), ing(2, "tbsp", "caster sugar"), ing(2, "tsp", "baking powder"), ing(null, "", "pinch of salt"), ing(2, "", "large eggs, separated"), ing(480, "ml", "milk"), ing(100, "g", "unsalted butter, melted"), ing(1, "tsp", "vanilla extract"), ing(null, "", "icing sugar and berries, to serve")],
    steps: ["Whisk the flour, sugar, baking powder and salt together.", "Whisk the egg yolks, milk, melted butter and vanilla, then stir into the dry ingredients.", "Whisk the egg whites to soft peaks and fold through the batter.", "Cook in a preheated waffle iron until golden and crisp.", "Dust with icing sugar and top with berries."],
    notes: "" },
  { id: "breakfast-fried-rice", title: "Breakfast Fried Rice", category: "Breakfast", time: "20 min", baseServings: 4,
    ingredients: [ing(500, "g", "cooked and chilled rice (day-old)"), ing(2, "tbsp", "vegetable oil"), ing(150, "g", "bacon, chopped"), ing(3, "", "large eggs, lightly beaten"), ing(150, "g", "frozen peas and corn"), ing(2, "", "spring onions, sliced"), ing(2, "tbsp", "soy sauce"), ing(1, "tsp", "sesame oil")],
    steps: ["Heat half the oil in a wok and scramble the eggs, then set aside.", "Add the remaining oil and fry the bacon until crisp.", "Add the rice, tossing to break up clumps and heat through.", "Add the peas, corn and soy sauce, tossing well.", "Fold through the egg and spring onion, and drizzle with sesame oil."],
    notes: "" },
  { id: "breakfast-couscous", title: "Breakfast Couscous with Dates and Pistachios", category: "Breakfast", time: "15 min", baseServings: 4,
    ingredients: [ing(200, "g", "couscous"), ing(250, "ml", "boiling water or apple juice"), ing(30, "g", "butter"), ing(80, "g", "dates, chopped"), ing(40, "g", "pistachios, chopped"), ing(1, "tsp", "ground cinnamon"), ing(200, "g", "Greek yoghurt"), ing(null, "", "honey, to drizzle")],
    steps: ["Pour the boiling liquid over the couscous, cover and stand 5 minutes, then fluff with a fork and stir through the butter.", "Stir through the dates, pistachios and cinnamon.", "Serve warm with a dollop of yoghurt and a drizzle of honey."],
    notes: "" },
  { id: "breakfast-smashed-peas-feta", title: "Smashed Peas and Feta on Toast", category: "Breakfast", time: "15 min", baseServings: 4,
    ingredients: [ing(300, "g", "frozen peas"), ing(100, "g", "feta, crumbled"), ing(1, "", "lemon, zested and juiced"), ing(2, "tbsp", "olive oil"), ing(null, "", "mint leaves, chopped"), ing(4, "", "slices sourdough, toasted"), ing(null, "", "chilli flakes, to serve")],
    steps: ["Blanch the peas in boiling water for 2 minutes, then drain.", "Roughly mash with the feta, lemon zest and juice, olive oil and mint, leaving some texture.", "Pile onto toast and finish with chilli flakes."],
    notes: "" },
  { id: "breakfast-nachos", title: "Breakfast Nachos", category: "Breakfast", time: "20 min", baseServings: 4,
    ingredients: [ing(200, "g", "corn chips"), ing(400, "g", "tinned black beans, drained"), ing(4, "", "large eggs"), ing(100, "g", "grated tasty cheese"), ing(1, "", "avocado, diced"), ing(100, "g", "salsa"), ing(null, "", "sour cream, to serve")],
    steps: ["Scatter the corn chips on an oven tray, top with black beans and cheese.", "Bake at 200°C fan-forced for 8 minutes until the cheese melts.", "Fry the eggs.", "Top the nachos with the eggs, avocado, salsa and sour cream."],
    notes: "" },
  { id: "breakfast-mango-lassi", title: "Mango Lassi Smoothie", category: "Breakfast", time: "5 min", baseServings: 2,
    ingredients: [ing(2, "", "ripe mangoes, chopped (or 400g frozen mango)"), ing(250, "g", "natural yoghurt"), ing(125, "ml", "milk"), ing(2, "tbsp", "honey"), ing(0.5, "tsp", "ground cardamom")],
    steps: ["Blend the mango, yoghurt, milk, honey and cardamom until smooth.", "Pour into glasses and serve chilled."],
    notes: "" },
  { id: "breakfast-green-smoothie", title: "Green Detox Smoothie", category: "Breakfast", time: "5 min", baseServings: 2,
    ingredients: [ing(60, "g", "baby spinach"), ing(1, "", "banana"), ing(150, "g", "pineapple, chopped"), ing(1, "", "green apple, cored and chopped"), ing(250, "ml", "coconut water"), ing(1, "tbsp", "chia seeds")],
    steps: ["Blend all the ingredients until smooth, adding a little extra coconut water if it's too thick.", "Pour and serve immediately."],
    notes: "" },
  { id: "breakfast-blueberry-pancakes", title: "Blueberry Pancakes", category: "Breakfast", time: "20 min", baseServings: 4,
    ingredients: [ing(300, "g", "self-raising flour"), ing(2, "tbsp", "caster sugar"), ing(null, "", "pinch of salt"), ing(2, "", "large eggs"), ing(350, "ml", "milk"), ing(50, "g", "butter, melted, plus extra for cooking"), ing(200, "g", "blueberries, fresh or frozen")],
    steps: ["Sift the dry ingredients into a bowl.", "Whisk the eggs, milk and melted butter, then stir into the dry ingredients until just combined.", "Gently fold through the blueberries.", "Cook spoonfuls in a buttered pan until bubbles form, flip and cook until golden."],
    notes: "" },
  { id: "breakfast-turkish-eggs", title: "Turkish Eggs (Çılbır)", category: "Breakfast", time: "20 min", baseServings: 4,
    ingredients: [ing(400, "g", "Greek yoghurt"), ing(2, "", "garlic cloves, crushed"), ing(8, "", "large eggs"), ing(1, "tbsp", "white vinegar"), ing(60, "g", "butter"), ing(1, "tbsp", "chilli flakes (Aleppo pepper if available)"), ing(null, "", "fresh dill, chopped"), ing(null, "", "crusty bread, to serve")],
    steps: ["Stir the garlic through the yoghurt and season.", "Poach the eggs in barely simmering water with the vinegar, about 3 minutes.", "Melt the butter with the chilli flakes until foaming and fragrant.", "Spread the garlic yoghurt over plates, top with poached eggs, drizzle with the chilli butter and scatter with dill.", "Serve with crusty bread."],
    notes: "" },
];
...
const SNACK_RECIPES = [
  { id: "snack-energy-balls", title: "Energy Balls", category: "Snacks", time: "15 min", scaling: "batch", yield: "Makes about 16", baseServings: 1,
    ingredients: [ing(200, "g", "pitted dates"), ing(100, "g", "rolled oats"), ing(60, "g", "almond meal"), ing(30, "g", "cocoa powder"), ing(60, "g", "peanut butter"), ing(1, "tbsp", "honey"), ing(null, "", "pinch of salt"), ing(40, "g", "desiccated coconut, for rolling")],
    steps: ["Blitz the dates in a food processor to a rough paste.", "Add the oats, almond meal, cocoa, peanut butter, honey and salt, and blend until it comes together.", "Roll into balls and coat in the coconut.", "Refrigerate for at least 30 minutes to firm up. Keeps a week in the fridge."],
    notes: "" },
  { id: "snack-hummus", title: "Hummus with Veggie Sticks", category: "Snacks", time: "10 min", baseServings: 4,
    ingredients: [ing(400, "g", "tin chickpeas, drained"), ing(2, "tbsp", "tahini"), ing(1, "", "lemon, juiced"), ing(1, "", "garlic clove, crushed"), ing(2, "tbsp", "olive oil"), ing(0.5, "tsp", "ground cumin"), ing(null, "", "salt, to taste"), ing(null, "", "carrot, celery and capsicum sticks, to serve")],
    steps: ["Blend the chickpeas, tahini, lemon juice, garlic, cumin and salt until smooth, adding a splash of water if it's too thick.", "Drizzle with olive oil and serve with vegetable sticks."],
    notes: "" },
  { id: "snack-trail-mix", title: "Homemade Trail Mix", category: "Snacks", time: "5 min", scaling: "batch", yield: "Makes about 500 g", baseServings: 1,
    ingredients: [ing(150, "g", "almonds"), ing(100, "g", "cashews"), ing(100, "g", "pepitas"), ing(100, "g", "dried cranberries"), ing(80, "g", "dark chocolate chips"), ing(50, "g", "coconut flakes")],
    steps: ["Combine everything in a large bowl or jar.", "Store in an airtight container for up to 3 weeks."],
    notes: "" },
  { id: "snack-spiced-popcorn", title: "Spiced Popcorn", category: "Snacks", time: "10 min", baseServings: 4,
    ingredients: [ing(100, "g", "popping corn"), ing(2, "tbsp", "vegetable oil"), ing(40, "g", "butter, melted"), ing(1, "tsp", "smoked paprika"), ing(0.5, "tsp", "garlic powder"), ing(null, "", "salt, to taste")],
    steps: ["Heat the oil in a large lidded pot over high heat. Add a few kernels — once they pop, add the rest and cover.", "Shake the pot occasionally until the popping slows to a few seconds between pops.", "Toss with the melted butter, paprika, garlic powder and salt."],
    notes: "" },
  { id: "snack-guacamole", title: "Guacamole with Corn Chips", category: "Snacks", time: "10 min", baseServings: 4,
    ingredients: [ing(3, "", "ripe avocados"), ing(1, "", "lime, juiced"), ing(0.5, "", "red onion, finely diced"), ing(1, "", "tomato, deseeded and diced"), ing(1, "tbsp", "coriander, chopped"), ing(0.5, "tsp", "chilli flakes"), ing(null, "", "salt, to taste"), ing(null, "", "corn chips, to serve")],
    steps: ["Mash the avocado roughly in a bowl.", "Stir through the lime juice, onion, tomato, coriander, chilli flakes and salt.", "Serve with corn chips."],
    notes: "" },
  { id: "snack-peanut-butter-apple", title: "Peanut Butter & Apple Slices", category: "Snacks", time: "5 min", baseServings: 2,
    ingredients: [ing(2, "", "apples, cored and sliced"), ing(4, "tbsp", "peanut butter"), ing(20, "g", "peanuts, chopped"), ing(1, "tsp", "honey, to drizzle, optional")],
    steps: ["Arrange the apple slices on a plate.", "Spoon or spread the peanut butter over.", "Scatter with chopped peanuts and drizzle with honey if using."],
    notes: "" },
  { id: "snack-yoghurt-parfait", title: "Yoghurt Berry Parfait", category: "Snacks", time: "5 min", baseServings: 2,
    ingredients: [ing(400, "g", "natural or Greek yoghurt"), ing(150, "g", "mixed berries"), ing(60, "g", "granola"), ing(1, "tbsp", "honey")],
    steps: ["Layer the yoghurt, berries and granola in glasses.", "Drizzle with honey to serve."],
    notes: "" },
  { id: "snack-savoury-muffins", title: "Ham & Cheese Savoury Muffins", category: "Snacks", time: "25 min", scaling: "batch", yield: "Makes 12", baseServings: 1,
    ingredients: [ing(300, "g", "self-raising flour"), ing(3, "", "large eggs"), ing(250, "ml", "milk"), ing(80, "ml", "olive oil"), ing(150, "g", "grated tasty cheese"), ing(100, "g", "ham, diced"), ing(2, "", "spring onions, sliced")],
    steps: ["Preheat oven to 180°C fan-forced and line a 12-hole muffin tin.", "Whisk the eggs, milk and oil together.", "Fold in the flour, then the cheese, ham and spring onion — mix until just combined, don't overmix.", "Spoon into the muffin holes and bake 20–25 minutes until golden and a skewer comes out clean."],
    notes: "" },
  { id: "snack-cheese-board", title: "Cheese & Crackers Board", category: "Snacks", time: "10 min", baseServings: 4,
    ingredients: [ing(300, "g", "mixed cheeses (cheddar, brie, blue)"), ing(150, "g", "crackers"), ing(100, "g", "grapes"), ing(50, "g", "dried apricots"), ing(30, "g", "mixed nuts"), ing(null, "", "honey, to drizzle")],
    steps: ["Arrange the cheeses on a board, leaving room to cut.", "Add the crackers, grapes, apricots and nuts around them.", "Drizzle a little honey over the softer cheeses just before serving."],
    notes: "" },
  { id: "snack-roasted-chickpeas", title: "Roasted Chickpeas", category: "Snacks", time: "30 min", baseServings: 4,
    ingredients: [ing(800, "g", "tinned chickpeas, drained and patted dry (two tins)"), ing(2, "tbsp", "olive oil"), ing(1, "tsp", "smoked paprika"), ing(0.5, "tsp", "ground cumin"), ing(0.5, "tsp", "garlic powder"), ing(null, "", "salt, to taste")],
    steps: ["Preheat oven to 200°C fan-forced.", "Toss the chickpeas with the oil and spices on a lined tray.", "Roast 25–30 minutes, shaking the tray halfway, until crisp.", "Cool slightly before serving — they crisp up further as they cool."],
    notes: "" },
  { id: "snack-devilled-eggs", title: "Devilled Eggs", category: "Snacks", time: "20 min", scaling: "batch", yield: "Makes 12 halves", baseServings: 1,
    ingredients: [ing(6, "", "large eggs"), ing(3, "tbsp", "mayonnaise"), ing(1, "tsp", "Dijon mustard"), ing(1, "tsp", "white vinegar"), ing(null, "", "smoked paprika, for dusting"), ing(null, "", "chives, chopped")],
    steps: ["Hard-boil the eggs (10–11 minutes), cool in iced water, then peel and halve.", "Scoop the yolks into a bowl and mash with the mayonnaise, mustard and vinegar until smooth.", "Pipe or spoon back into the whites.", "Dust with paprika and scatter with chives."],
    notes: "" },
  { id: "snack-vegetable-spring-rolls", title: "Baked Vegetable Spring Rolls", category: "Snacks", time: "35 min", scaling: "batch", yield: "Makes 16", baseServings: 1,
    ingredients: [ing(1, "tbsp", "vegetable oil"), ing(2, "", "garlic cloves, crushed"), ing(1, "tbsp", "grated ginger"), ing(200, "g", "cabbage, shredded"), ing(100, "g", "carrot, grated"), ing(100, "g", "bean sprouts"), ing(2, "tbsp", "soy sauce"), ing(1, "tsp", "sesame oil"), ing(16, "", "spring roll wrappers"), ing(null, "", "oil spray")],
    steps: ["Heat the oil and stir-fry the garlic and ginger for 30 seconds.", "Add the cabbage and carrot and stir-fry 3–4 minutes until softened.", "Stir through the bean sprouts, soy sauce and sesame oil, then cool.", "Spoon filling onto the wrappers and roll up, sealing the edges with water.", "Spray with oil and bake at 200°C fan-forced for 15–18 minutes until golden and crisp."],
    notes: "" },
  { id: "snack-cheese-vegemite-scrolls", title: "Cheese and Vegemite Scrolls", category: "Snacks", time: "35 min", scaling: "batch", yield: "Makes 8", baseServings: 1,
    ingredients: [ing(375, "g", "self-raising flour"), ing(40, "g", "butter, chopped"), ing(250, "ml", "milk"), ing(3, "tbsp", "Vegemite"), ing(150, "g", "grated tasty cheese")],
    steps: ["Preheat oven to 200°C fan-forced and line a tray.", "Rub the butter into the flour until it resembles breadcrumbs, then stir in the milk to form a soft dough.", "Turn out and pat into a rectangle.", "Spread with Vegemite and scatter with most of the cheese.", "Roll up from the long side and cut into 8 pieces.", "Place cut-side up on the tray, scatter with the remaining cheese, and bake 20–22 minutes until golden."],
    notes: "" },
  { id: "snack-caprese-skewers", title: "Caprese Skewers", category: "Snacks", time: "10 min", baseServings: 4,
    ingredients: [ing(250, "g", "cherry tomatoes"), ing(250, "g", "bocconcini"), ing(null, "", "fresh basil leaves"), ing(2, "tbsp", "olive oil"), ing(1, "tbsp", "balsamic glaze"), ing(null, "", "salt and pepper")],
    steps: ["Thread a tomato, basil leaf and bocconcini onto small skewers.", "Arrange on a platter.", "Drizzle with olive oil and balsamic glaze, and season to serve."],
    notes: "" },
  { id: "snack-sweet-potato-fries", title: "Baked Sweet Potato Fries", category: "Snacks", time: "35 min", baseServings: 4,
    ingredients: [ing(800, "g", "sweet potato, cut into chips"), ing(2, "tbsp", "olive oil"), ing(1, "tsp", "smoked paprika"), ing(0.5, "tsp", "garlic powder"), ing(null, "", "salt, to taste")],
    steps: ["Preheat oven to 220°C fan-forced.", "Toss the sweet potato with the oil, paprika, garlic powder and salt.", "Spread on a lined tray in a single layer.", "Bake 25–30 minutes, turning halfway, until golden and crisp at the edges."],
    notes: "" },
  { id: "snack-rice-paper-rolls", title: "Fresh Rice Paper Rolls", category: "Snacks", time: "30 min", scaling: "batch", yield: "Makes 12", baseServings: 1,
    ingredients: [ing(12, "", "rice paper wrappers"), ing(150, "g", "vermicelli noodles, cooked"), ing(200, "g", "cooked prawns, halved (or extra vegetables)"), ing(1, "", "carrot, julienned"), ing(1, "", "Lebanese cucumber, julienned"), ing(null, "", "mint and coriander leaves"), ing(60, "ml", "hoisin sauce, to serve"), ing(60, "ml", "peanut sauce, to serve")],
    steps: ["Dip a rice paper wrapper in warm water until just pliable.", "Lay flat and top with noodles, prawn, carrot, cucumber and herbs.", "Fold in the sides and roll up tightly. Repeat with the remaining wrappers.", "Serve with hoisin and peanut dipping sauces."],
    notes: "" },
  { id: "snack-beef-jerky", title: "Homemade Beef Jerky", category: "Snacks", time: "5 hrs + marinating", scaling: "batch", yield: "Makes about 300 g", baseServings: 1,
    ingredients: [ing(1, "kg", "beef eye round, trimmed of fat and thinly sliced"), ing(125, "ml", "soy sauce"), ing(2, "tbsp", "Worcestershire sauce"), ing(1, "tbsp", "brown sugar"), ing(1, "tsp", "smoked paprika"), ing(0.5, "tsp", "chilli flakes"), ing(2, "", "garlic cloves, crushed")],
    steps: ["Combine the soy sauce, Worcestershire, sugar, paprika, chilli and garlic.", "Toss through the sliced beef and marinate in the fridge at least 4 hours, or overnight.", "Arrange the strips in a single layer on wire racks over trays.", "Dry in the oven at its lowest setting (around 70–80°C) with the door slightly ajar for 4–5 hours, until firm and dry but still pliable.", "Cool completely before storing airtight."],
    notes: "" },
  { id: "snack-loaded-nachos", title: "Loaded Nachos", category: "Snacks", time: "20 min", baseServings: 4,
    ingredients: [ing(200, "g", "corn chips"), ing(400, "g", "tinned black beans, drained"), ing(200, "g", "grated tasty cheese"), ing(1, "", "avocado, diced"), ing(100, "g", "sour cream"), ing(100, "g", "salsa"), ing(1, "", "jalapeño, sliced"), ing(null, "", "coriander, to serve")],
    steps: ["Spread the corn chips on an oven tray and scatter with beans and cheese.", "Bake at 200°C fan-forced for 8–10 minutes until melted.", "Top with avocado, sour cream, salsa, jalapeño and coriander."],
    notes: "" },
  { id: "snack-stuffed-mini-capsicums", title: "Stuffed Mini Capsicums", category: "Snacks", time: "30 min", scaling: "batch", yield: "Makes about 20", baseServings: 1,
    ingredients: [ing(20, "", "mini capsicums, halved and deseeded"), ing(250, "g", "cream cheese, softened"), ing(100, "g", "grated tasty cheese"), ing(100, "g", "bacon, cooked and chopped"), ing(2, "", "spring onions, sliced")],
    steps: ["Preheat oven to 190°C fan-forced.", "Mix the cream cheese, cheese, bacon and spring onion together.", "Spoon into the capsicum halves.", "Bake 15–18 minutes until the capsicum is tender and the filling golden."],
    notes: "" },
  { id: "snack-peanut-butter-oat-bars", title: "Peanut Butter Oat Bars (No-Bake)", category: "Snacks", time: "15 min + 2 hrs chilling", scaling: "batch", yield: "Makes 16 bars", baseServings: 1,
    ingredients: [ing(250, "g", "rolled oats"), ing(200, "g", "peanut butter"), ing(150, "g", "honey"), ing(50, "g", "dark chocolate chips"), ing(null, "", "pinch of salt")],
    steps: ["Line a 20cm square tin with baking paper.", "Warm the peanut butter and honey together until runny, then stir through the salt.", "Stir through the oats until well coated.", "Press firmly into the tin, scatter with chocolate chips and press in.", "Chill at least 2 hours before cutting into bars."],
    notes: "" },
  { id: "snack-mozzarella-sticks", title: "Mozzarella Sticks with Marinara", category: "Snacks", time: "20 min + 90 min freezing", scaling: "batch", yield: "Makes 12", baseServings: 1,
    ingredients: [ing(12, "", "mozzarella string cheese sticks"), ing(60, "g", "plain flour"), ing(2, "", "large eggs, beaten"), ing(150, "g", "breadcrumbs"), ing(1, "tsp", "dried oregano"), ing(null, "", "oil, for frying"), ing(250, "ml", "marinara or tomato sauce, to serve")],
    steps: ["Freeze the mozzarella sticks for at least 1 hour.", "Coat each stick in flour, then egg, then breadcrumbs mixed with oregano — repeat the egg and crumb step for a thicker coating.", "Freeze again for 30 minutes.", "Deep or shallow fry in hot oil until golden, 1–2 minutes.", "Serve immediately with warmed marinara."],
    notes: "" },
  { id: "snack-ham-cream-cheese-pinwheels", title: "Ham and Cream Cheese Pinwheels", category: "Snacks", time: "15 min + 1 hr chilling", scaling: "batch", yield: "Makes about 20", baseServings: 1,
    ingredients: [ing(4, "", "large flour tortillas"), ing(250, "g", "cream cheese, softened"), ing(8, "", "slices leg ham"), ing(100, "g", "baby spinach"), ing(1, "", "carrot, grated")],
    steps: ["Spread each tortilla with cream cheese.", "Layer with ham, spinach and grated carrot.", "Roll up tightly and wrap in cling film.", "Chill at least 1 hour, then slice into pinwheels."],
    notes: "" },
  { id: "snack-fruit-kebabs", title: "Fruit Kebabs with Yoghurt Dip", category: "Snacks", time: "15 min", baseServings: 4,
    ingredients: [ing(200, "g", "watermelon, cubed"), ing(200, "g", "strawberries, halved"), ing(2, "", "kiwifruit, chopped"), ing(200, "g", "pineapple, chopped"), ing(200, "g", "Greek yoghurt"), ing(1, "tbsp", "honey")],
    steps: ["Thread the fruit onto skewers, alternating for colour.", "Stir the honey through the yoghurt.", "Serve the kebabs with the yoghurt dip alongside."],
    notes: "" },
  { id: "snack-fruit-yoghurt-popsicles", title: "Fruit and Yoghurt Popsicles", category: "Snacks", time: "15 min + 6 hrs freezing", scaling: "batch", yield: "Makes 8", baseServings: 1,
    ingredients: [ing(400, "g", "Greek yoghurt"), ing(200, "g", "mixed berries"), ing(2, "tbsp", "honey")],
    steps: ["Blend half the berries with the yoghurt and honey until smooth.", "Roughly chop the remaining berries and stir through for texture.", "Pour into popsicle moulds, insert sticks, and freeze at least 6 hours or overnight."],
    notes: "" },
  { id: "snack-zucchini-chips", title: "Baked Zucchini Chips", category: "Snacks", time: "35 min", baseServings: 4,
    ingredients: [ing(2, "", "large zucchini, thinly sliced"), ing(2, "", "large eggs, beaten"), ing(100, "g", "breadcrumbs"), ing(40, "g", "grated parmesan"), ing(1, "tsp", "dried oregano"), ing(null, "", "oil spray")],
    steps: ["Preheat oven to 200°C fan-forced and line two trays.", "Dip the zucchini slices in egg, then coat in breadcrumbs mixed with parmesan and oregano.", "Arrange in a single layer and spray with oil.", "Bake 20–25 minutes, turning halfway, until golden and crisp."],
    notes: "" },
  { id: "snack-roasted-edamame", title: "Crunchy Roasted Edamame", category: "Snacks", time: "30 min", baseServings: 4,
    ingredients: [ing(300, "g", "frozen shelled edamame, thawed and patted dry"), ing(1, "tbsp", "vegetable oil"), ing(1, "tsp", "sea salt"), ing(0.5, "tsp", "chilli flakes"), ing(0.5, "tsp", "garlic powder")],
    steps: ["Preheat oven to 200°C fan-forced.", "Toss the edamame with the oil, salt, chilli and garlic powder.", "Spread on a lined tray in a single layer.", "Roast 20–25 minutes, shaking the tray halfway, until golden and crunchy."],
    notes: "" },
  { id: "snack-salsa-tortilla-chips", title: "Salsa with Homemade Tortilla Chips", category: "Snacks", time: "20 min", baseServings: 4,
    ingredients: [ing(6, "", "small flour or corn tortillas, cut into wedges"), ing(2, "tbsp", "olive oil"), ing(null, "", "salt, to taste"), ing(4, "", "ripe tomatoes, diced"), ing(0.5, "", "red onion, finely diced"), ing(1, "tbsp", "coriander, chopped"), ing(1, "", "lime, juiced"), ing(0.5, "tsp", "chilli flakes")],
    steps: ["Preheat oven to 200°C fan-forced.", "Toss the tortilla wedges with oil and salt, spread on a tray and bake 8–10 minutes until crisp.", "Combine the tomatoes, onion, coriander, lime juice and chilli for the salsa.", "Serve together."],
    notes: "" },
  { id: "snack-antipasto-platter", title: "Antipasto Platter", category: "Snacks", time: "10 min", baseServings: 6,
    ingredients: [ing(150, "g", "sliced prosciutto"), ing(150, "g", "salami"), ing(200, "g", "marinated olives"), ing(200, "g", "roasted capsicum strips"), ing(200, "g", "bocconcini"), ing(150, "g", "sun-dried tomatoes"), ing(null, "", "crusty bread, to serve")],
    steps: ["Arrange the meats, cheese and marinated vegetables on a large platter or board.", "Serve with crusty bread."],
    notes: "" },
  { id: "snack-mini-quiches", title: "Mini Quiches", category: "Snacks", time: "35 min", scaling: "batch", yield: "Makes 12", baseServings: 1,
    ingredients: [ing(2, "", "sheets shortcrust pastry"), ing(4, "", "large eggs"), ing(150, "ml", "thickened cream"), ing(100, "g", "grated tasty cheese"), ing(100, "g", "bacon or ham, chopped"), ing(2, "", "spring onions, sliced")],
    steps: ["Preheat oven to 180°C fan-forced.", "Cut rounds from the pastry and press into a 12-hole muffin tin.", "Whisk the eggs and cream, then stir through the cheese, bacon and spring onion.", "Pour into the pastry cases.", "Bake 20–25 minutes until set and golden."],
    notes: "" },
  { id: "snack-chocolate-dipped-strawberries", title: "Chocolate-Dipped Strawberries", category: "Snacks", time: "20 min", scaling: "batch", yield: "Makes about 20", baseServings: 1,
    ingredients: [ing(20, "", "strawberries"), ing(200, "g", "dark chocolate, chopped"), ing(50, "g", "white chocolate, chopped, optional")],
    steps: ["Melt the dark chocolate in a heatproof bowl over simmering water, or in short microwave bursts.", "Dip each strawberry two-thirds of the way, letting the excess drip off.", "Place on baking paper to set.", "Melt the white chocolate and drizzle over if using. Chill until firm."],
    notes: "" },
  { id: "snack-rice-cracker-mix", title: "Rice Cracker Snack Mix", category: "Snacks", time: "20 min", scaling: "batch", yield: "Makes about 400 g", baseServings: 1,
    ingredients: [ing(150, "g", "rice crackers"), ing(100, "g", "wasabi peas"), ing(100, "g", "roasted peanuts"), ing(50, "g", "dried wakame or nori snacks, optional"), ing(2, "tbsp", "soy sauce"), ing(1, "tsp", "sesame oil")],
    steps: ["Toss the rice crackers, wasabi peas and peanuts with the soy sauce and sesame oil.", "Spread on a tray and bake at 150°C fan-forced for 8–10 minutes until fragrant, tossing halfway.", "Cool completely before storing airtight."],
    notes: "" },
  { id: "snack-baked-apple-chips", title: "Baked Apple Chips", category: "Snacks", time: "2 hrs", scaling: "batch", yield: "Makes about 40 chips", baseServings: 1,
    ingredients: [ing(4, "", "apples, very thinly sliced"), ing(1, "tsp", "ground cinnamon")],
    steps: ["Preheat oven to 100°C fan-forced and line two trays.", "Arrange the apple slices in a single layer, dusting with cinnamon.", "Bake 1½–2 hours, flipping halfway, until dry and crisp.", "Cool completely — they crisp up further as they cool."],
    notes: "" },
  { id: "snack-loaded-sweet-potato-skins", title: "Loaded Sweet Potato Skins", category: "Snacks", time: "1 hr", baseServings: 4,
    ingredients: [ing(4, "", "small sweet potatoes"), ing(2, "tbsp", "olive oil"), ing(150, "g", "bacon, chopped"), ing(100, "g", "grated tasty cheese"), ing(100, "g", "sour cream"), ing(2, "", "spring onions, sliced")],
    steps: ["Preheat oven to 200°C fan-forced.", "Pierce the sweet potatoes and bake 45–50 minutes until tender.", "Halve, scoop out some flesh leaving a shell, and brush the skins with oil.", "Fry the bacon until crisp.", "Fill the skins with cheese and bacon, and bake a further 10 minutes until the cheese melts.", "Top with sour cream and spring onion."],
    notes: "" },
  { id: "snack-chilli-lime-corn", title: "Chilli Lime Corn on the Cob", category: "Snacks", time: "15 min", baseServings: 4,
    ingredients: [ing(4, "", "corn cobs, husked"), ing(60, "g", "butter, melted"), ing(1, "", "lime, juiced and zested"), ing(0.5, "tsp", "chilli powder"), ing(40, "g", "grated parmesan"), ing(null, "", "coriander, chopped, to serve")],
    steps: ["Boil or grill the corn until tender, 8–10 minutes.", "Brush with the melted butter mixed with lime juice, zest and chilli powder.", "Scatter with parmesan and coriander."],
    notes: "" },
  { id: "snack-smoked-salmon-cucumber-bites", title: "Smoked Salmon Cucumber Bites", category: "Snacks", time: "15 min", scaling: "batch", yield: "Makes about 20", baseServings: 1,
    ingredients: [ing(1, "", "large cucumber, sliced into rounds"), ing(150, "g", "cream cheese"), ing(150, "g", "smoked salmon"), ing(1, "tbsp", "capers"), ing(null, "", "fresh dill"), ing(null, "", "lemon wedges, to serve")],
    steps: ["Spread a little cream cheese onto each cucumber round.", "Top with a piece of smoked salmon, a few capers and a sprig of dill.", "Serve with lemon wedges."],
    notes: "" },
];
...
/* pulls the first number out of a time string for sorting — "hrs" is
   converted to minutes so "1½–2 hrs" sorts correctly against "30–35 min" */
const firstTimeMinutes = (time) => {
  if (!time) return Infinity;
  const m = String(time).match(/(\d+(?:[.,½¼¾]\d*)?)/);
  if (!m) return Infinity;
  const n = parseFloat(m[1].replace("½", ".5").replace("¼", ".25").replace("¾", ".75"));
  if (Number.isNaN(n)) return Infinity;
  return /hr|hour/i.test(time) ? n * 60 : n;
};
...
const PALETTES = {
  olive: {
    label: "Olive Grove",
    light: { bg: "#F2F0E6", card: "#FCFBF5", ink: "#22301F", inkSoft: "#5A6653", green: "#33502F", greenDeep: "#243A21", mustard: "#C07A17", mustardSoft: "#F3E3C4", line: "#DCD9C8", danger: "#A93E2C", onPrimary: "#F4F2E4", onAccent: "#241A05", accentText: "#6E4A0C", noteText: "#5C3E0A", headMut: "#7A8470", faint: "#73756A", disabledText: "#615F52" },
    dark: { bg: "#161A13", card: "#1F251B", ink: "#E8EADD", inkSoft: "#A6AF9A", green: "#33502F", greenDeep: "#243A21", mustard: "#D89A3E", mustardSoft: "#453615", line: "#343C2E", danger: "#D0654F", onPrimary: "#F4F2E4", onAccent: "#241A05", accentText: "#E8C27C", noteText: "#E8C27C", headMut: "#8A957D", faint: "#838D76", disabledText: "#9DA68E" },
  },
  bluegum: {
    label: "Blue Gum",
    light: { bg: "#EEF1F2", card: "#FAFCFC", ink: "#1E2B31", inkSoft: "#56676F", green: "#2E4E57", greenDeep: "#203941", mustard: "#C2703D", mustardSoft: "#F2DFCE", line: "#D7DDDE", danger: "#A93E2C", onPrimary: "#EDF3F2", onAccent: "#2A1608", accentText: "#7A4620", noteText: "#6B3D1B", headMut: "#7C8B90", faint: "#6F7577", disabledText: "#5B6264" },
    dark: { bg: "#12181B", card: "#1B2429", ink: "#E4EBEC", inkSoft: "#9DAEB2", green: "#29444D", greenDeep: "#1C3238", mustard: "#D98C50", mustardSoft: "#4A2F17", line: "#2C383D", danger: "#D0654F", onPrimary: "#EDF3F2", onAccent: "#2A1608", accentText: "#EDBE8F", noteText: "#EDBE8F", headMut: "#7E9096", faint: "#788D94", disabledText: "#8CA2A8" },
  },
  muskstick: {
    label: "Musk Stick",
    light: { bg: "#F8F0F3", card: "#FDF9FB", ink: "#34222B", inkSoft: "#755966", green: "#A83E68", greenDeep: "#8A3255", mustard: "#2E7F78", mustardSoft: "#CFE8E4", line: "#E6D8DE", danger: "#A93E2C", onPrimary: "#FDF4F8", onAccent: "#EAF7F5", accentText: "#1C5750", noteText: "#174A44", headMut: "#97808B", faint: "#7D6F77", disabledText: "#6A5D64" },
    dark: { bg: "#1C1216", card: "#271A20", ink: "#F0E2E9", inkSoft: "#B79AA8", green: "#B14A74", greenDeep: "#8A3255", mustard: "#4FB3A9", mustardSoft: "#143D38", line: "#3A2A32", danger: "#D0654F", onPrimary: "#FDF4F8", onAccent: "#0E2B27", accentText: "#9ADCD3", noteText: "#9ADCD3", headMut: "#8F7A85", faint: "#997D8B", disabledText: "#A88E9B" },
  },
  terracotta: {
    label: "Terracotta",
    light: { bg: "#F5EFE9", card: "#FCF8F4", ink: "#33251D", inkSoft: "#6F5B4E", green: "#9C4E2C", greenDeep: "#7C3D20", mustard: "#5F7A4E", mustardSoft: "#DDE8D3", line: "#E2D7CC", danger: "#A93E2C", onPrimary: "#FAF2EB", onAccent: "#F2F8EC", accentText: "#3D5330", noteText: "#33472A", headMut: "#91816F", faint: "#7C7165", disabledText: "#685D4E" },
    dark: { bg: "#191210", card: "#241A16", ink: "#EFE4DB", inkSoft: "#B5A091", green: "#A65634", greenDeep: "#7C3D20", mustard: "#7FA267", mustardSoft: "#2A3A1F", line: "#37291F", danger: "#D0654F", onPrimary: "#FAF2EB", onAccent: "#16240E", accentText: "#B9D6A4", noteText: "#B9D6A4", headMut: "#8C7C6C", faint: "#96806C", disabledText: "#A48F79" },
  },
  midnight: {
    label: "Midnight",
    light: { bg: "#EEF1F5", card: "#FAFBFD", ink: "#1C2634", inkSoft: "#55627A", green: "#23364E", greenDeep: "#16283C", mustard: "#B8862B", mustardSoft: "#F0E3C2", line: "#D8DDE4", danger: "#A93E2C", onPrimary: "#EFF3F8", onAccent: "#241A05", accentText: "#6E4E12", noteText: "#5C400C", headMut: "#7D8798", faint: "#6E747D", disabledText: "#5B626C" },
    dark: { bg: "#10151C", card: "#192129", ink: "#E3E9F0", inkSoft: "#9AA8BA", green: "#2A415E", greenDeep: "#1C2F45", mustard: "#D3A24A", mustardSoft: "#423412", line: "#2A3440", danger: "#D0654F", onPrimary: "#EFF3F8", onAccent: "#241A05", accentText: "#E7C382", noteText: "#E7C382", headMut: "#7A8798", faint: "#78899D", disabledText: "#8C9CB1" },
  },
  lamington: {
    label: "Lamington",
    light: { bg: "#F3EEE9", card: "#FBF8F4", ink: "#2E241E", inkSoft: "#6C5A4F", green: "#4A3226", greenDeep: "#382418", mustard: "#B4466A", mustardSoft: "#F3D9E2", line: "#E0D6CC", danger: "#A93E2C", onPrimary: "#F6EFE9", onAccent: "#FBF0F4", accentText: "#7E2C4A", noteText: "#6B2540", headMut: "#8F7F72", faint: "#7B7066", disabledText: "#685C4E" },
    dark: { bg: "#171210", card: "#221B16", ink: "#EDE4DC", inkSoft: "#B3A294", green: "#54382A", greenDeep: "#3E2A1E", mustard: "#D06A8C", mustardSoft: "#46202E", line: "#362B22", danger: "#D0654F", onPrimary: "#F6EFE9", onAccent: "#2E0F1A", accentText: "#EFA9C0", noteText: "#EFA9C0", headMut: "#8B7C6E", faint: "#95806F", disabledText: "#A5917E" },
  },
  plum: {
    label: "Plum",
    light: { bg: "#F4EFF1", card: "#FCF9FA", ink: "#2E2129", inkSoft: "#6B5762", green: "#5A2E4B", greenDeep: "#43223A", mustard: "#B98A2E", mustardSoft: "#F0E2C3", line: "#E0D5DA", danger: "#A93E2C", onPrimary: "#F6EFF3", onAccent: "#241A05", accentText: "#6E4E12", noteText: "#5C400C", headMut: "#907C88", faint: "#7C7077", disabledText: "#665B61" },
    dark: { bg: "#1A1318", card: "#251B22", ink: "#ECE2E8", inkSoft: "#B09CA8", green: "#4E2A42", greenDeep: "#3A1F32", mustard: "#D3A24A", mustardSoft: "#4A3814", line: "#3A2C35", danger: "#D0654F", onPrimary: "#F6EFF3", onAccent: "#241A05", accentText: "#E7C382", noteText: "#E7C382", headMut: "#8F7B87", faint: "#967F8D", disabledText: "#A7929E" },
  },
};
...
const CATEGORIES = ["Breakfast", "Snacks", "Weeknight", "Pasta", "Curry", "Soup", "Roast", "Salad", "Sides", "Stir-fry", "Casserole", "Cakes", "Slices", "Biscuits & Cookies", "Tarts & Pastries", "Breads", "Loaves, Muffins & Other", "Other"];
...
/* ---------- planner dates & meal slots ----------
   ...
   The plan is keyed by ISO date, each holding one entry list per slot:
     { "2026-07-20": { breakfast: [], lunch: [entry], dinner: [entry], snack: [] } }
...
const emptyDay = () => Object.fromEntries(SLOTS.map(([id]) => [id, []]));
const dayAt = (plan, iso) => {
  const d = plan[iso];
  return Object.fromEntries(SLOTS.map(([id]) => [id, d && Array.isArray(d[id]) ? d[id] : []]));
};
const dayEntries = (day) => SLOTS.flatMap(([id]) => day[id]);
const dayCount = (plan, iso) => dayEntries(dayAt(plan, iso)).length;
/* drop days that have emptied out, so the stored plan doesn't grow forever */
const pruneDay = (plan, iso, day) => {
  const next = { ...plan };
  if (!dayEntries(day).length) delete next[iso];
  else next[iso] = day;
  return next;
};
...
const migratePlan = (old) => {
  ...
  DAYS.forEach((d, i) => {
    ...
    if (entries.length) out[isoDate(addDays(monday, i))] = { ...emptyDay(), dinner: entries };
  });
  return out;
};
...
const migrateTemplatePlan = (tp) => Object.fromEntries(DAYS.map((d) => {
  const v = tp && tp[d];
  if (Array.isArray(v)) return [d, { ...emptyDay(), dinner: v }];
  return [d, Object.fromEntries(SLOTS.map(([id]) => [id, Array.isArray(v?.[id]) ? v[id] : []]))];
}));
...
export default function TheKitchen() {
  ...
  const deleteRecipe = (id) => {
    ...
    persistPlan(Object.entries(plan).reduce((acc, [iso]) => {
      const d = dayAt(plan, iso);
      const kept = Object.fromEntries(SLOTS.map(([slot]) => [slot, d[slot].filter((e) => e.recipeId !== id)]));
      if (dayEntries(kept).length) acc[iso] = kept;
      return acc;
    }, {}));
    setView({ page: "list" });
  ...
  const saveTemplate = (name, dates) => {
    const tplPlan = Object.fromEntries(dates.map((iso, i) => [DAYS[i], dayAt(plan, iso)]));
  ...
  const applyTemplate = (tpl, dates) => {
    ...
    dates.forEach((iso, i) => {
      ...
      const day = Object.fromEntries(SLOTS.map(([slot]) => [slot, src[slot].map((e) => ({ ...e, id: uid() }))]));
      if (dayEntries(day).length) next[iso] = day;
...
function ListPage({ recipes, favs, toggleFav, query, setQuery, cat, setCat, open, onNew }) {
  ...
  const lastCooked = (r) => (r.cooked || []).length ? r.cooked[r.cooked.length - 1] : "";
  const sorters = {
    az: (a, b) => a.title.localeCompare(b.title),
    za: (a, b) => b.title.localeCompare(a.title),
    quickest: (a, b) => firstTimeMinutes(a.time) - firstTimeMinutes(b.time) || a.title.localeCompare(b.title),
    rating: (a, b) => (b.rating || 0) - (a.rating || 0) || a.title.localeCompare(b.title),
    recent: (a, b) => lastCooked(b).localeCompare(lastCooked(a)) || a.title.localeCompare(b.title),
  };
  const sorted = [...filtered].sort(sorters[sortBy] || sorters.az);

  // the seed library alone is ~200 recipes — rendering all of them at once
  // was a real cognitive-load and scan-cost problem, so page the grid and
  // reset back to one page whenever the result set actually changes
  const PAGE_SIZE = 48;
  const [visibleCount, setVisibleCount] = useState(PAGE_SIZE);
  useEffect(() => { setVisibleCount(PAGE_SIZE); }, [query, cat, skillFilter, dietFilters, sortBy]);
    ...
    <div>
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: 10, alignItems: "center" }}>
        ...
        <select
          ...
          style={{
            marginLeft: "auto", border: `1px solid ${C.line}`, background: C.card, color: C.inkSoft,
            borderRadius: RADIUS.pill, padding: "6px 12px", fontSize: 12.5, fontWeight: 600,
          }}
        >
          <option value="az">Sort: A–Z</option>
          <option value="za">Sort: Z–A</option>
          <option value="quickest">Sort: Quickest first</option>
          <option value="rating">Sort: Highest rated</option>
          <option value="recent">Sort: Recently cooked</option>
        </select>
      </div>
      ...
      {sorted.length > visible.length && (
        <div style={{ textAlign: "center", marginTop: 20 }}>
          <button
            ...
            style={{ background: C.card, color: C.ink, border: `1px solid ${C.line}`, borderRadius: RADIUS.pill, padding: "10px 22px", fontSize: 13.5, fontWeight: 600 }}
          >
            Show {Math.min(PAGE_SIZE, sorted.length - visible.length)} more · {visible.length} of {sorted.length}
          </button>
        </div>
      )}
    </div>
...
function LeftoverSuggestions({ iso, slot, plan, recipes, household, addEntry }) {
  // only lunch <-> dinner have a natural leftovers relationship — breakfast
  // and snack don't chain from either, so there's nothing to suggest there
  if (!household || (slot !== "lunch" && slot !== "dinner")) return null;
...
function StaleFavourites({ recipes, plan, dates, openRecipe }) {
  const plannedIds = new Set(dates.flatMap((iso) => dayEntries(dayAt(plan, iso)).map((e) => e.recipeId)));
...
function EditPage({ recipe, settings, knownCategories = CATEGORIES, onCancel, onSave }) {
  ...
  // a line that doesn't match a leading amount/unit still becomes an
  // ingredient (the whole line as its name, no amount) rather than vanishing —
  // but the user has no way to tell which lines fell back like that unless
  // we count and say so
  const countUnparsedAmounts = (lines) => lines.filter((l) => parseIngredientLine(l)?.amount == null).length;
  ...
  const runImport = () => {
    ...
    if (jl) {
      ...
      const unclear = countUnparsedAmounts(jl.ingLines);
      setPasteMsg(
        `Found structured recipe data — filled in ${jl.ingLines.length} ingredients and ${jl.stepLines.length} steps. Worth a quick check, but this should be accurate.` +
        (unclear ? ` ${unclear} ingredient${unclear === 1 ? "" : "s"} had no clear amount and kept the full line as-is — worth a look.` : "")
      );
      return;
    }
    ...
    const unclear = countUnparsedAmounts(p.ingLines);
    setPasteMsg(
      `Filled in ${p.ingLines.length} ingredients and ${p.stepLines.length} steps — check them over below, then save.` +
      (unclear ? ` ${unclear} ingredient${unclear === 1 ? "" : "s"} had no clear amount and kept the full line as-is — worth a look.` : "")
    );
  };
    ...
    <div style={{ maxWidth: 620 }}>
      ...
      <section className="k-flat" style={settingsCard()}>
        ...
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
          ...
          {/* the app's only two-tap destructive action — everything else is a
              single tap + undo toast, but this one wipes the entire local
              kitchen with no cloud copy, so it earns a heavier gate: tap once
              to arm, tap again within 4s to actually wipe (still backed by
              the same 10s undo toast once triggered) */}
          <button className="k-press"
            onClick={() => {
              if (confirmReset) {
                ...
                confirmResetTimer.current = setTimeout(() => setConfirmReset(false), 4000);
              }
            }}
            style={{
              background: confirmReset ? C.danger : C.bg,
              border: `1px solid ${confirmReset ? C.danger : C.line}`,
              borderRadius: 999, padding: "9px 18px", fontSize: 13.5,
              color: confirmReset ? C.onPrimary : C.danger, fontWeight: confirmReset ? 700 : 500,
            }}
          >
            {confirmReset ? "Tap again to wipe everything" : "Reset everything"}
          </button>
        </div>
      </section>
    </div>
